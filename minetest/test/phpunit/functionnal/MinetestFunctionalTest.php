...
/**
 * \file    test/phpunit/MinetestFunctionalTest.php
 * \ingroup minetest
 ...
 *
 * @package Testminetest
 */
class MinetestFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/minetest/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('minetest/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/minetest/admin/about.php');
		$this->authenticate();
		return $this->assertContains('minetest/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('minetestwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMinetest_MinetestTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMinetest_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
